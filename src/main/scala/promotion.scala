 ...
 */
  def timeline(t: Double): List[Edge3D] = {
    val i = t % 360
    if (0<= i && i < 60) {
      WFM.rotateEdge3D(WFM.test05a, 0d, 30d) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, 30d), new Point3D(0d, 0d, 150d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, 30d - i), new Point3D(0d, 0d, 300d)) ++
      ...
      WFM.rotateEdge3D(WFM.test05a, 0d, 30d) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, 90d - i), new Point3D(0d, 0d, 150d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, i - 90d), new Point3D(0d, 0d, 300d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.data06, 0d, 180d), new Point3D(-10d, -40d, 0d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.data06, 0d, 180d), new Point3D(-10d, -40d, 150d + 2.5 * (i - 60d))) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.data06, 0d, 180d), new Point3D(-10d, -40d, 300d + 2.5 * i))

    } else if(120 <= i && i < 180) {
      WFM.rotateEdge3D(WFM.test05a, 0d, 150d - i) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, i - 150d), new Point3D(0d, 0d, 150d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, 30d), new Point3D(0d, 0d, 300d)) ++
      ...
      WFM.rotateEdge3D(WFM.test05a, 0d, i - 210d) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, 30d), new Point3D(0d, 0d, 150d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, 30d), new Point3D(0d, 0d, 300d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.data06, 0d, 180d), new Point3D(-10d, -40d, 150d)) ++
      WFM.translateEdge3D(WFM.rotateEdge3D(WFM.data06, 0d, 180d), new Point3D(-10d, -40d, 300d)) ++
...
/*    var model = WFM.rotateEdge3D(WFM.test05a, 0d, inpR.value.toDouble) ++
                WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, inpR.value.toDouble * -1), new Point3D(0d, 0d, 100d)) ++
                WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, inpR.value.toDouble), new Point3D(0d, 0d, 200d)) */
...
/*      model = WFM.rotateEdge3D(WFM.test05a, 0d, inpR.value.toDouble) ++
                WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05b, 0d, inpR.value.toDouble * -1), new Point3D(0d, 0d, 100d)) ++
                WFM.translateEdge3D(WFM.rotateEdge3D(WFM.test05c, 0d, inpR.value.toDouble), new Point3D(0d, 0d, 200d)) */
      WFM.draw(ctx, model, new Window(inp.value.toDouble, cnv.width/2d, cnv.height/4d))
    }
